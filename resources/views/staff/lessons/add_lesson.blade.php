            ...
            <div class=" mt-4">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="lessonForm" action="{{ route('staff.lessons.addLesson') }}" method="post"
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="10" required></textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <button type="button" onclick="submitForm()" class="btn btn-primary">Add Lesson</button>
                            </form>
                        </div>
                    </div>
                </div>
